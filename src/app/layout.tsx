  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="blima-garcia-psicologa";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Blima García Psicóloga"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="blima-garcia-psicologa"
          data-primary-color="#62857d"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="blima-garcia-psicologa";
